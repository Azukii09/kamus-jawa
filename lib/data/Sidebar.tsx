...
export const SideMenu = [
    {
        ...
        icon:<DashboardSVG className={"size-5"}/>,
        link:"/",
        active:false,
    },
    {
    ...
    },
    {
        id:3,
        menuName:"Profil",
        icon:<Profile2 className={"size-5"}/>,
        link:"/",
        active:false,
    },
    {
        id:4,
        menuName:"Kamus",
        icon:<DictionarySVG className={"size-5"}/>,
        link:"/",
        active:true,
    },
    {
    ...
    },
    {
        id:6,
        menuName:"Kebudayaan",
        icon:<JatimSVG className={"size-5"}/>,
        link:"/",
        active:false,
    },
    {
        id:7,
        menuName:"Pengaturan",
        icon:<SettingSVG className={"size-5"}/>,
        link:"/",
        active:false,
    },
]