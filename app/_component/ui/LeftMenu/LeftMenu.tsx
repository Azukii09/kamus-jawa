            ...
            <div className={"w-full h-full flex flex-col items-center justify-between pb-8"}>
                <ul className={"mt-6 h-full flex flex-col justify-between"}>
                    <li className={"relative px-4 py-3 w-full"}>
                        {SideMenu.map((item, index) => (
                            <div className={"py-3 w-full"} key={index}>
                                <Link
                                    href={"/"}
                                    className={`${item.active? "bg-white text-primary hover:text-red-500":"hover:bg-white hover:text-red-500"}  py-2 px-6 inline-flex items-center w-full font-bold transition-colors duration-150 rounded-full`}
                                >
                                    {item.icon}
                    ...
                    <li className={"relative px-4 py-3 w-full"}>
                        <Link
                            href={"/"}
                            className={`hover:bg-white hover:text-red-500 py-2 px-6 inline-flex items-center w-full font-bold transition-colors duration-150 rounded-full`}
                        >
                            <DoorOutSvg className={"size-5"}/>
