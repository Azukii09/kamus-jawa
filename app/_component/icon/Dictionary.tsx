export default function DictionarySVG({className}: {className: string}) {
    return (
        <svg
            className={className}
            version="1.1"
